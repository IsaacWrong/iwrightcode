...
Before advising, read `CLAUDE.md` for the full stack, conventions, and workflow rules. Key points: Next.js 15 App Router, Supabase RLS on all tables, Stripe webhooks, Vercel deploy. Production readiness checks must include RLS correctness, auth patterns, Stripe webhook reliability, and E2E test coverage.
